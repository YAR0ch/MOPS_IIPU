        ...
        Image {
            ...
            Button {
                ...
                style: ButtonStyle {
                    background: Image {
                        ...
                        source: control.pressed ? "exit1.png" :
                                                  (control.hovered ? "exit2.png" : "exit1.png")
                    }
                }
            ...
            Button {
                ...
                style: ButtonStyle {
                    background: Image {
                        fillMode: Image.PreserveAspectFit
                        source: control.pressed ? "МОПС1.png" :
                                                  (control.hovered ? "МОПС2.png" : "МОПС1.png")
                    }
            ...
            Button {
                ...
                style: ButtonStyle {
                    background: Image {
                        fillMode: Image.PreserveAspectFit
                        source: control.pressed ? "МП11.png" :
                                                  (control.hovered ? "МП11.png" : "МП1.png")
                    }

                }
                onClicked: image2.source = "фон1.jpg"
            }
            ...
            Button {
                ...
                style: ButtonStyle {
                    background: Image {
                        fillMode: Image.PreserveAspectFit
                        source: control.pressed ? "МП22.png" :
                                                  (control.hovered ? "МП22.png" : "МП2.png")
                    }

                }
                onClicked: image2.source = "фон2.jpg"
            }
            ...
            Button {
                ...
                style: ButtonStyle {
                    background: Image {
                        fillMode: Image.PreserveAspectFit
                        source: control.pressed ? "МП33.png" :
                                                  (control.hovered ? "МП33.png" : "МП3.png")
                    }

                }
                onClicked: image2.source = "фон3.jpg"
            }
...
//            }
            ...
            Image {
                ...
                TextEdit {
                    ...
                    width: 470
                    height: 396
                    text: qsTr("Над проектом трудились белорусские парни: \n \n  Мицкевич Артём Витальевич \n  Яровенко Дмитрий Максимович \n  Полозков Павел Александрович \n\
\n \n \n\n\n\n\n\n\n\n\n\n\n\n                                   ©MopsTechnologies   2022")
                    font.pixelSize: 12
                }
            }
